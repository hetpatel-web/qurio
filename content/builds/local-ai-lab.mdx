...
- The related notes [Docker Basics](/notes/docker-basics), [Ollama Basics](/notes/ollama-basics), and [n8n Workflow Basics](/notes/n8n-workflow-basics) explain the concepts underneath the build.
- The related experiments [Local AI Lab 001: First n8n to Ollama Test](/experiments/local-ai-lab-001-first-n8n-ollama-test), [Local AI Lab 002: First n8n to Ollama Workflow](/experiments/local-ai-lab-002-first-n8n-ollama-workflow), and [Local AI Lab 003: Summarizing Qurio Notes with Ollama and n8n](/experiments/local-ai-lab-003-summarizing-qurio-notes-with-ollama-and-n8n) prove the system incrementally.
