...
- Models and runtimes are different concepts and should be treated separately.
- Small models are better for learning than jumping straight to large ones.
- A local API matters as much as the model itself when the goal is integration.
- Docker and Ollama work well together because one manages services and the other manages models.
